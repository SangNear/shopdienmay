...
const ProductCart = ({ name, slug, image, price }: ProductCartProps) => {
  return (
    ...
    <Link
      ...
      className="w-[165px] lg:w-[220px] h-[320px] rounded-xl shadow-xl bg-white flex flex-col justify-between relative">
      ...
      <div className="p-2 w-full">
        <h4 className="text-xs text-black">
      ...
      <div className="flex flex-col  gap-1 p-2 ">
        ...
        <div className="flex  gap-2 ">
          ...
          <span className="text-xs text-[#78c63b] text-left">Còn hàng</span>
        </div>
      </div>
    </Link>
  );
